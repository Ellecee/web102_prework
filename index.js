...
const totalUnfunded = GAMES_JSON.reduce( (acc, game) => acc + (game.pledged < game.goal ? 1 : 0), 0);

// create a string that explains the number of unfunded games using the ternary operator
const unfundedStr =
 `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames} ${totalGames === 1 ? "game" : "games"}. 
 Currently, ${totalUnfunded} ${totalUnfunded === 1 ? "game remains" : "games remain"} unfunded. 
 We need your help to fund these amazing games!`
console.log(unfundedStr);

// create a new DOM element containing the template string and append it to the description container
const descriptionElement = document.createElement("p");
descriptionElement.innerHTML = unfundedStr;
